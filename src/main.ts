...
import MemoryRespositoryFactory from "./infra/factory/MemoryRepositoryFactory";
...
import OrdeRepositoryMemory from "./infra/repository/memory/OrderRepositoryMemory";
...
const orderRepository = new OrdeRepositoryMemory();
